...
module.exports.electionDelete = async (req: Request, res: Response) => {
...
module.exports.electionGet = async (req: Request, res: Response) => {
  const year = parseInt(req.params.year as string)
  const client = await pool.connect()
...
module.exports.electionPost = async (req: Request, res: Response) => {
